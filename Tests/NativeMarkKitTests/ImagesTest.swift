...
final class ImagesTest: XCTestCase {
    func testCase568() throws {
        ...
        XCTAssertEqual(try compile("![foo](/url \"title\")\n"),
                       Document(elements: [.paragraph([.image(Link(title: "title", url: URL(string: "/url")), text: [.text("foo")])])]))
    }
    ...
    func testCase569() throws {
        ...
        XCTAssertEqual(try compile("![foo *bar*]\n\n[foo *bar*]: train.jpg \"train & tracks\"\n"),
                       Document(elements: [.paragraph([.image(Link(title: "train & tracks", url: URL(string: "train.jpg")), text: [.text("foo bar")])])]))
    }
    ...
    func testCase570() throws {
        ...
        XCTAssertEqual(try compile("![foo ![bar](/url)](/url2)\n"),
                       Document(elements: [.paragraph([.image(Link(title: "", url: URL(string: "/url2")), text: [.text("foo bar")])])]))
    }
    ...
    func testCase574() throws {
        ...
        XCTAssertEqual(try compile("![foo](train.jpg)\n"),
                       Document(elements: [.paragraph([.image(Link(title: "", url: URL(string: "train.jpg")), text: [.text("foo")])])]))
    }
    ...
    func testCase575() throws {
        ...
        XCTAssertEqual(try compile("My ![foo bar](/path/to/train.jpg  \"title\"   )\n"),
                       Document(elements: [.paragraph([.text("My "), .image(Link(title: "title", url: URL(string: "/path/to/train.jpg")), text: [.text("foo bar")])])]))
    }
    ...
    func testCase576() throws {
        ...
        XCTAssertEqual(try compile("![foo](<url>)\n"),
                       Document(elements: [.paragraph([.image(Link(title: "", url: URL(string: "url")), text: [.text("foo")])])]))
    }
    ...
    func testCase577() throws {
        ...
        XCTAssertEqual(try compile("![](/url)\n"),
                       Document(elements: [.paragraph([.image(Link(title: "", url: URL(string: "/url")), text: [.text("")])])]))
    }
    ...
    func testCase581() throws {
        ...
        // Debug: <p><img></img></p>\n
        XCTAssertEqual(try compile("![*foo* bar][]\n\n[*foo* bar]: /url \"title\"\n"),
                       Document(elements: [.paragraph([.image(Link(title: "title", url: URL(string: "/url")), text: [.text("foo bar")])])]))
    }
    ...
    func testCase583() throws {
        ...
        // Debug: <p><img></img>\n[]</p>\n
        XCTAssertEqual(try compile("![foo] \n[]\n\n[foo]: /url \"title\"\n"),
                       Document(elements: [.paragraph([.image(Link(title: "title", url: URL(string: "/url")), text: [.text("foo")]), .text("[]")])]))
    }
    ...
    func testCase589() throws {
        ...
        // Debug: <p>!<a>foo</a></p>\n
        XCTAssertEqual(try compile("\\![foo]\n\n[foo]: /url \"title\"\n"),
                       Document(elements: [.paragraph([.text("!"), .link(Link(title: "title", url: URL(string: "/url")), text: [.text("foo")])])]))
    }
