...
final class ListsTest: XCTestCase {
    ...
    func testCase275() throws {
        ...
        // Debug: <p>The number of windows in my house is</p>\n<ol>\n<li>{The number of doors is 6. caused p to open}The number of doors is 6.</li>\n</ol>\n
    ...
    func testCase280() throws {
        // HTML: <ul>\n<li>a</li>\n<li>b</li>\n<li>c</li>\n<li>d</li>\n<li>e</li>\n<li>f</li>\n<li>g</li>\n</ul>\n
        // Debug: <ul>\n<li>{a caused p to open}a</li>\n<li>{b caused p to open}b</li>\n<li>{c caused p to open}c</li>\n<li>{d caused p to open}d</li>\n<li>{e caused p to open}e</li>\n<li>{f caused p to open}f</li>\n<li>{g caused p to open}g</li>\n</ul>\n
