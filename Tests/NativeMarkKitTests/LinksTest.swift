    ...
    func testCase524() throws {
        ...
        XCTAssertEqual(try compile("[link [foo [bar]]][ref]\n\n[ref]: /uri\n"),
                       Document(elements: [
                        ...
                        LinkDefinition(label: InlineString(text: "[ref]", range: (2,0)-(2,4)),
                                       link: Link(title: nil,
                                                  url: InlineString(text: "/uri", range: (2, 7)-(2, 10))),
                                       range: (2,0)-(2,11))
                       ]))
    ...
    func testCase536() throws {
        ...
        XCTAssertEqual(try compile("[Толпой][Толпой] is a Russian word.\n\n[ТОЛПОЙ]: /url\n"),
                       Document(elements: [
                        ...
                        LinkDefinition(label: InlineString(text: "[ТОЛПОЙ]", range: (2,0)-(2,7)),
                                       link: Link(title: nil,
                                                  url: InlineString(text: "/url", range: (2, 10)-(2, 13))),
                                       range: (2,0)-(2,14))
                       ]))
    ...
    func testCase537() throws {
        ...
        XCTAssertEqual(try compile("[Foo\n  bar]: /url\n\n[Baz][Foo bar]\n"),
                       Document(elements: [
                        ...
                        LinkDefinition(label: InlineString(text: "[Foo\n  bar]", range: (0,0)-(1,5)),
                                       link: Link(title: nil,
                                                  url: InlineString(text: "/url", range: (1, 8)-(1, 11))),
                                       range: (0,0)-(1,12))
                       ]))
    ...
    func testCase539() throws {
        ...
        XCTAssertEqual(try compile("[foo]\n[bar]\n\n[bar]: /url \"title\"\n"),
                       Document(elements: [
                        ...
                        LinkDefinition(label: InlineString(text: "[bar]", range: (3,0)-(3,4)),
        ...
        XCTAssertEqual(try compile("[foo]: /url1\n\n[foo]: /url2\n\n[bar][foo]\n"),
                       Document(elements: [
                        ...
                        LinkDefinition(label: InlineString(text: "[foo]", range: (2,0)-(2,4)),
                                       link: Link(title: nil,
                                                  url: InlineString(text: "/url2", range: (2, 7)-(2, 11))),
                                       range: (2,0)-(2,12))
                       ]))
    }
    ...
    func testCase541() throws {
        ...
        XCTAssertEqual(try compile("[bar][foo\\!]\n\n[foo!]: /url\n"),
                       Document(elements: [
                        ...
                        LinkDefinition(label: InlineString(text: "[foo!]", range: (2,0)-(2,5)),
                                       link: Link(title: nil,
                                                  url: InlineString(text: "/url", range: (2,8)-(2,11))),
                                       range: (2,0)-(2,12))
                       ]))
    }
    ...
    func testCase545() throws {
        ...
        XCTAssertEqual(try compile("[foo][ref\\[]\n\n[ref\\[]: /uri\n"),
                       Document(elements: [
                        ...
                        LinkDefinition(label: InlineString(text: "[ref\\[]", range: (2,0)-(2,6)),
                                       link: Link(title: nil,
                                                  url: InlineString(text: "/uri", range: (2, 9)-(2, 12))),
                                       range: (2,0)-(2,13))
                       ]))
    ...
    func testCase546() throws {
        ...
        XCTAssertEqual(try compile("[bar\\\\]: /uri\n\n[bar\\\\]\n"),
                       Document(elements: [
                        ...
                        LinkDefinition(label: InlineString(text: "[bar\\\\]", range: (0,0)-(0,6)),
                                       link: Link(title: nil,
                                                  url: InlineString(text: "/uri", range: (0, 9)-(0, 12))),
                                       range: (0,0)-(0,13))
                       ]))
    ...
    func testCase560() throws {
        ...
        XCTAssertEqual(try compile("[foo*]: /url\n\n*[foo*]\n"),
                       Document(elements: [
                        ...
                        LinkDefinition(label: InlineString(text: "[foo*]", range: (0,0)-(0,5)),
                                       link: Link(title: nil,
                                                  url: InlineString(text: "/url", range: (0, 8)-(0, 11))),
                                       range: (0,0)-(0,12))
                       ]))
    ...
    func testCase565() throws {
        ...
        XCTAssertEqual(try compile("[foo][bar][baz]\n\n[baz]: /url\n"),
                       Document(elements: [
                        ...
                        LinkDefinition(label: InlineString(text: "[baz]", range: (2,0)-(2,4)),
                                       link: Link(title: nil,
                                                  url: InlineString(text: "/url", range: (2, 7)-(2, 10))),
                                       range: (2,0)-(2,11))
                       ]))
