...
final class LinksTest: XCTestCase {
    ...
    func testCase488() throws {
        // HTML: <p>[link](<foo\nbar>)</p>\n
        // Debug: <p>[link](<foo>)</foo></p>\n
        XCTAssertEqual(try compile("[link](<foo\nbar>)\n"),
                       Document(elements: [.paragraph([.text("[link](<foo bar>"), .softbreak, .text(" )"), .softbreak, .text("</foo>")])]))
    }
    ...
    func testCase491() throws {
        ...
        // Debug: <p>[a](<b)c\n[a](<b)c>\n[a](<b>c)</b></p><b>\n</b>
        XCTAssertEqual(try compile("[a](<b)c\n[a](<b)c>\n[a](<b>c)\n"),
                       Document(elements: [.paragraph([.text("[a](<b)c"), .softbreak, .text("[a](<b)c>"), .softbreak, .text("[a](<b>c)</b>")])]))
    }
